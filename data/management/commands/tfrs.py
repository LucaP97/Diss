...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # As an example, let's get the top 3 recommendations for user with id "10".
        _, tweet_ids = index(np.array(["10"]))
        print(f"Top 3 recommendations for user 10: {tweet_ids[0, :3]}")
